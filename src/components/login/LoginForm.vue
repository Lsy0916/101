    ...
    <div class="social-login">
      ...
      <div class="social-login-buttons">
        <el-tooltip :content="t('login.social.wechat')" placement="bottom">
          <button class="social-btn wechat-btn" @click="debouncedHandleWechatLogin" :aria-label="t('login.social.wechat')">
        ...
        <el-tooltip content="QQ登录" placement="bottom">
          <button class="social-btn qq-btn" @click="debouncedHandleQQLogin" aria-label="QQ登录">
            <svg viewBox="0 0 1024 1024" width="22" height="22">
